...
pdfParser.on("pdfParser_dataReady", pdfData => {
    let rawText = pdfParser.getRawTextContent().replaceAll('\u200b', '');
    // console.log(rawText);
    // fs.writeFileSync("./output.json", rawText);
    ...
    // Post-process articulation ANDs (not doing it in the loop so we can still debug check and stuff) 
...
pdfParser.loadPDF("../scrapers/assist-pdfs/Allan_Hancock_College/Aerospace_Engineering__B_S_---26284155.pdf");